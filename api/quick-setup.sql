-- Script RÁPIDO e SIMPLES para configurar o banco de dados
-- Execute este script no console do Neon (SQL Editor)
-- Este script funciona mesmo se já existirem algumas tabelas
...
-- Criar índices (seguro para executar múltiplas vezes)
